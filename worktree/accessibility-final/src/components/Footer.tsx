        ...
        <footer className="w-full bg-[#354F3D] py-6 text-center text-sm text-white" dir="rtl">
            <div className="container px-4">
                ...
                <p className="mx-auto max-w-4xl text-sm leading-relaxed text-white/90">
                    ...
                    <a href="https://www.digital-forest.org.il/" className="font-medium underline underline-offset-2 hover:text-white" target="_blank" rel="noopener noreferrer">
                        יער עירוני דיגיטלי
                    </a>{" "}
                    ו-
                    <a href="https://www.treecatalog.org.il/" className="font-medium underline underline-offset-2 hover:text-white" target="_blank" rel="noopener noreferrer">
                        קטלוג עצי רחוב וצל
                    </a>{" "}
